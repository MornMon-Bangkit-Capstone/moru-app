...
import com.capstone.moru.databinding.ItemLoadingBinding

class LoadingStateListAdapter(private val retry : () -> Unit): LoadStateAdapter<LoadingStateListAdapter.LoadingStateViewHolder>()  {
